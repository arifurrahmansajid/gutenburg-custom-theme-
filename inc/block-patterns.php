...
if ( ! function_exists( 'realome_register_block_patterns' ) ) :
	...
	function realome_register_block_patterns() {
		...
		$block_patterns = array(
			...
			'single-post-toc-pills',
			'single-post-related-service',
			'single-post-author-bio',
			'single-post-spotlight-banner',
			'single-post-faq-accordion',
			'single-post-bottom-cta',
			'single-post-more-articles-grid',
			'reel-revival-featured-card',
			'reel-revival-archive-grid',
			'reel-revival-category-filter',
			'reel-to-reel-hero',
