<?php
/**
 * Title: Discs We Accept — DVD & Disc Formats Grid
 * Slug: realome/discs-we-accept
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: Discs we accept, DVD, Mini DVD, CD, DVD-R, DVD-RW, finalized discs, home movies
 */
?>
