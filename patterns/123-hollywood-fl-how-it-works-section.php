<?php
/**
 * Title: Hollywood, FL How It Works Section
 * Slug: realome/hollywood-fl-how-it-works-section
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: Hollywood FL how it works, local drop-off, in-person pickup, local pickup, studio map, 6630 meade street
 */
