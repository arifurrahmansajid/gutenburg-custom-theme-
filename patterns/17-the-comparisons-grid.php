<?php
/**
 * Title: The Comparisons Competitor Cards Grid
 * Slug: realome/the-comparisons-grid
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: The comparisons, legacybox comparison, imemories, capture, everpresent, costco
 */
?>
