<?php
/**
 * Title: Microcassette Hero Section
 * Slug: realome/microcassette-hero
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: Microcassette to Digital, Every Word Saved, minicassette, dictation, audio transfer, Hollywood FL
 */
?>
