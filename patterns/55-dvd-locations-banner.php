<?php
/**
 * Title: DVD to Digital Locations Banner
 * Slug: realome/dvd-locations-banner
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: DVD to digital, South Florida, locations, Hollywood, Miami, Fort Lauderdale, Boca Raton
 */
?>
		...
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
				...
				<div class="vhs-location-pills-row">
					<span class="vhs-loc-pill vhs-loc-pill-white">Hollywood</span>
