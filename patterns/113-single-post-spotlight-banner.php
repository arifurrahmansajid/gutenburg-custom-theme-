<?php
/**
 * Title: Single Post Spotlight Banner (The Bigger Picture)
 * Slug: realome/single-post-spotlight-banner
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: spotlight banner, living memories, bigger picture
 */
?>
