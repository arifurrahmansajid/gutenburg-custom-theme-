<?php
/**
 * Title: Living Memories Hero Banner
 * Slug: realome/lm-hero-preserved
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: Living memories, hero, legacy, documentary, discovery call, sample video, South Florida
 */
?>
