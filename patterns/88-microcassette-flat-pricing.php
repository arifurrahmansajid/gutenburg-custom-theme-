<?php
/**
 * Title: Simple, Flat Pricing — Microcassette
 * Slug: realome/microcassette-flat-pricing
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: Simple flat pricing microcassette, audio transfer pricing table, CD authoring, USB flash drive, $18 per tape
 */
?>
