 ...
 * Slug: realome/what-we-restore
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: What we restore, photo restoration, tears creases, fading discoloration, water mold damage, missing pieces holes, color shift, colorization, stuck to glass
 */
?>
<!-- wp:group {"align":"full","className":"vhs-restore-section","style":{"color":{"background":"#ffffff"},"spacing":{"padding":{"top":"80px","bottom":"80px","left":"24px","right":"24px"}}},"layout":{"type":"constrained","contentSize":"1350px"}} -->
<div class="wp-block-group alignfull vhs-restore-section has-background" style="background-color:#ffffff;padding-top:80px;padding-right:24px;padding-bottom:80px;padding-left:24px">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group" style="margin-bottom:36px">
			...
			<h2 class="wp-block-heading has-text-color" style="color:#16324f;font-size:38px;font-weight:800;line-height:1.15;margin-top:0px;margin-bottom:12px">What We <span style="color:#39B7EC">Restore</span>.</h2>
			<!-- /wp:heading -->
		...
		<!-- Row 1 (4 Cards) -->
		<!-- wp:columns {"className":"vhs-restore-grid","style":{"spacing":{"blockGap":"16px","margin":{"top":"0px","bottom":"16px"}}}} -->
		<div class="wp-block-columns vhs-restore-grid" style="margin-top:0px;margin-bottom:16px">
		...
		<!-- Row 2 (4 Cards) -->
		<!-- wp:columns {"className":"vhs-restore-grid","style":{"spacing":{"blockGap":"16px","margin":{"top":"0px","bottom":"0px"}}}} -->
