<?php
/**
 * Title: Original Film Before/After Hero Banner
 * Slug: realome/film-before-after-hero-banner
 * Categories: vhs-sections, hero, featured, realome, pages
 * Keywords: 8mm, super 8, film to digital, 5k scan, before after, interactive slider
 */
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
				...
				<div class="wp-block-group vhs-ba-container">
					...
					<div class="wp-block-group vhs-ba-before-layer">
						...
						<!-- wp:image {"url":"<?php echo $before_url; ?>","alt":"Before - 8mm frame beach day 1967","className":"vhs-ba-img vhs-ba-img-before","sizeSlug":"full","linkDestination":"none"} -->
						<figure class="wp-block-image size-full vhs-ba-img vhs-ba-img-before"><img src="<?php echo $before_url; ?>" alt="Before - 8mm frame beach day 1967"/></figure>
						<!-- /wp:image -->
					...
					<div class="wp-block-group vhs-ba-after-layer">
						...
						<!-- wp:image {"url":"<?php echo $after_url; ?>","alt":"After - Same frame 5K scan","className":"vhs-ba-img vhs-ba-img-after","sizeSlug":"full","linkDestination":"none"} -->
						<figure class="wp-block-image size-full vhs-ba-img vhs-ba-img-after"><img src="<?php echo $after_url; ?>" alt="After - Same frame 5K scan"/></figure>
						<!-- /wp:image -->
