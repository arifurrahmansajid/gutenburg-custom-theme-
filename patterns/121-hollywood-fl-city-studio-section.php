<?php
/**
 * Title: Hollywood, FL City Studio Section
 * Slug: realome/hollywood-fl-city-studio-section
 * Categories: vhs-sections, featured, realome, pages
 * Keywords: Hollywood FL city studio, emerald hills, hollywood lakes, landmarks footage, broadwalk, artspark
 */
